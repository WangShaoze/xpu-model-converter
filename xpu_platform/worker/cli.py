...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--queue", default=os.environ.get("XPU_QUEUE", "memory"),
    ...
    parser.add_argument("--workspace", default=os.environ.get("XPU_WORKSPACE", "./worker-workspace"))
...
def main(argv=None) -> int:
    ...
    # 本地 SQLite 开发库: 未迁移时自动建表; 生产 Postgres 走 Alembic 迁移
    ...
    scheduler = WorkerScheduler(
        ...
        worker=worker, workspace_root=args.workspace, max_retries=args.max_retries,
    )
