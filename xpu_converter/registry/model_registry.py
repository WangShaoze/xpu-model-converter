...
SUPPORT_TABLE: List[ModelSupport] = [
    ...
    ModelSupport("yolov8-seg", STATUS_EXPERIMENTAL, "pytorch", "segment", "ultralytics>=8.0"),
    ModelSupport("yolov8-pose", STATUS_EXPERIMENTAL, "pytorch", "pose", "ultralytics>=8.0"),
    ModelSupport("yolov8-obb", STATUS_EXPERIMENTAL, "pytorch", "obb", "ultralytics>=8.0"),
    ModelSupport("yolov8-cls", STATUS_EXPERIMENTAL, "pytorch", "cls", "ultralytics>=8.0"),
    ModelSupport("yolov9", STATUS_EXPERIMENTAL, "pytorch", "detection", ""),
    ModelSupport("yolov9-seg", STATUS_EXPERIMENTAL, "pytorch", "segment", ""),
    ModelSupport("yolov7", STATUS_EXPERIMENTAL, "pytorch", "detection", ""),
    ModelSupport("yolov7-pose", STATUS_EXPERIMENTAL, "pytorch", "pose", ""),
    ModelSupport("yolov7-seg", STATUS_EXPERIMENTAL, "pytorch", "segment", ""),
    ...
    ModelSupport("yolov11-seg", STATUS_EXPERIMENTAL, "pytorch", "segment", "ultralytics>=8.3"),
    ModelSupport("yolov11-pose", STATUS_EXPERIMENTAL, "pytorch", "pose", "ultralytics>=8.3"),
    ModelSupport("yolov11-obb", STATUS_EXPERIMENTAL, "pytorch", "obb", "ultralytics>=8.3"),
    ModelSupport("yolov11-cls", STATUS_EXPERIMENTAL, "pytorch", "cls", "ultralytics>=8.3"),
    ...
    ModelSupport("yolov26-seg", STATUS_EXPERIMENTAL, "pytorch", "segment", ""),
    ModelSupport("yolov26-pose", STATUS_EXPERIMENTAL, "pytorch", "pose", ""),
    ModelSupport("yolov26-obb", STATUS_EXPERIMENTAL, "pytorch", "obb", ""),
    ModelSupport("yolov26-cls", STATUS_EXPERIMENTAL, "pytorch", "cls", ""),
    ModelSupport("yolov26-depth", STATUS_EXPERIMENTAL, "pytorch", "depth", ""),
    ModelSupport("yolov26-sem", STATUS_EXPERIMENTAL, "pytorch", "sem", ""),
...
# 注意: 任务是子串匹配, 任务/体量专属的前缀必须排在通用版本前缀之前, 否则
# ``yolov8s-seg.pt`` 会被 ``yolov8`` 抢先识别为检测。
FILENAME_HINTS: List[tuple] = [
    ("yolov7-w6-pose", "yolov7-pose"),
    ("yolov7-seg", "yolov7-seg"),
    ("yolov7-mask", "yolov7-seg"),
    ("gelan-c-seg", "yolov9-seg"),
    ("yolov9c-seg", "yolov9-seg"),
    ("yolov9e-seg", "yolov9-seg"),
    ("gelan", "yolov9"),
    # ultralytics 系任务权重形如 ``yolov8s-seg.pt``(体量字母位于版本与任务之间),
    # 须按实际提供的 n/s 体量逐个体量登记, 且排在通用 ``yolov8`` 前缀之前。
    ("yolov8n-seg", "yolov8-seg"), ("yolov8s-seg", "yolov8-seg"),
    ("yolov8n-pose", "yolov8-pose"), ("yolov8s-pose", "yolov8-pose"),
    ("yolov8n-obb", "yolov8-obb"), ("yolov8s-obb", "yolov8-obb"),
    ("yolov8n-cls", "yolov8-cls"), ("yolov8s-cls", "yolov8-cls"),
    ("yolo11n-seg", "yolov11-seg"), ("yolo11s-seg", "yolov11-seg"),
    ("yolo11n-pose", "yolov11-pose"), ("yolo11s-pose", "yolov11-pose"),
    ("yolo11n-obb", "yolov11-obb"), ("yolo11s-obb", "yolov11-obb"),
    ("yolo11n-cls", "yolov11-cls"), ("yolo11s-cls", "yolov11-cls"),
    ("yolo26n-seg", "yolov26-seg"), ("yolo26s-seg", "yolov26-seg"),
    ("yolo26n-pose", "yolov26-pose"), ("yolo26s-pose", "yolov26-pose"),
    ("yolo26n-obb", "yolov26-obb"), ("yolo26s-obb", "yolov26-obb"),
    ("yolo26n-cls", "yolov26-cls"), ("yolo26s-cls", "yolov26-cls"),
    ("yolo26n-depth", "yolov26-depth"), ("yolo26s-depth", "yolov26-depth"),
    ("yolo26n-sem", "yolov26-sem"), ("yolo26s-sem", "yolov26-sem"),
    ("yolov5", "yolov5"),
    ("yolov6", "yolov6"),
    ("yolov7", "yolov7"),
    ("yolov8", "yolov8"),
